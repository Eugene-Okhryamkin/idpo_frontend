...
const AddCourse = props => {
    ...
    const onHandleChangeCourse = e => {
        ...
        setEditedCourse({
            ...editedCourse, [name]: e.currentTarget.value,
        });
    ...
    const onHandleSubmit = e => {
        console.log(editedCourse);
        e.preventDefault();
        fetch("http://194.67.116.27:8080/api/edit/add_course", {
            method: "POST",
            headers: {
            ...
            <div className="add-form m-5">
                ...
                <form className="col-lg-6">
                    ...
                    <div className="form-group my-2">
                        ...
                        <select className="form-control" id="role1" name="programTypeId" onChange={onHandleChangeCourse}>
                    ...
                    <div className="form-group my-2">
                        ...
                        <select className="form-control" id="role2" name="programDirectionId" onChange={onHandleChangeCourse}>
                            <option selected>Выберете...</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                    ...
                    <div className="form-group my-2">
                        ...
                        <input type="text" className="form-control" id="cgroup" placeholder="Введите группу" name="programGroupId" onChange={onHandleChangeCourse}/>
                    </div>
                    <div className="my-2">
                    ...
                    <div className="form-group row my-2">
                        <label htmlFor="number-input" className="col-8 col-form-label" style={{paddingLeft: "0"}}>Трудоемкость
                            (в часах):</label>
                        <div className="col-4">
                            <input className="form-control" type="number" value={editedCourse.laborIntensity} id="number-input" name="laborIntensity" onChange={onHandleChangeCourse}/>
                        </div>
                    </div>
